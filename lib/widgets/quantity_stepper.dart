  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            // definisikan class stepper button
            _StepperButton(icon: Icons.remove_rounded, onTap: onDecrement),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 18),
              child: Text('$quantity', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
            ),
            _StepperButton(icon: Icons.add_outlined, onTap: onIncrement),
          ],
        )
      ],
    );
